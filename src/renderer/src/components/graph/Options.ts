...
// Types for cytoscape-expand-collapse options are not available, so we define a minimal interface.
...
const expandCollapseOptions: ExpandCollapseOptions = {
...
export default expandCollapseOptions
