...
interface FcoseLayoutOptions extends LayoutOptions {
  ...
  numIter?: number
  tile?: boolean
  tilingCompareBy?: ((nodeId1: string, nodeId2: string) => number) | undefined
  ...
  fixedNodeConstraint?: { nodeId: string; position: { x: number; y: number } }[] | undefined
  alignmentConstraint?: { vertical: string[][]; horizontal: string[][] } | undefined
  relativePlacementConstraint?:
    | { top?: string; bottom?: string; left?: string; right?: string; gap?: number }[]
    | undefined
}
